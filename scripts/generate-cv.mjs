...
function html(t) {
  return `<!doctype html><html><head><meta charset="utf-8"><style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    body { font-family: Inter, -apple-system, "Segoe UI", Roboto, Helvetica, Arial, sans-serif; color: #1f2937; font-size: 10px; line-height: 1.42; }

    .header { background: #021C35; color: #fff; padding: 22px 40px 18px; }
    ...
    .body { padding: 18px 40px 12px; }
    h2 { font-size: 11px; font-weight: 800; text-transform: uppercase; letter-spacing: 2px; color: #021C35; margin: 14px 0 7px; padding-bottom: 4px; border-bottom: 2px solid #C9A227; }
    ...
    .footer { margin-top: 10px; font-size: 8.5px; color: #9CA3AF; text-align: center; }
  </style></head><body>
    <div class="header">
