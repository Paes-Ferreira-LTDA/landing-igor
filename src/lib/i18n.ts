...
export const t = {
  en: {
    ...
    hero: {
      ...
      desc: "Technical founder passionate about product development, innovation, analytics and business. Electrical engineer. 7 years at Volvo. 8 years building B2B platforms. Shipped",
  ...
  pt: {
    ...
    hero: {
      ...
      desc: "Founder técnico apaixonado por desenvolvimento de produtos, inovação, análise e negócios. Engenheiro eletricista. 7 anos na Volvo. 8 anos construindo plataformas B2B. Coloquei em produção",
